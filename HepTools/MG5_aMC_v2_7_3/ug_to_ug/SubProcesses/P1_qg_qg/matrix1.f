...
C     
C     Process: u g > u g WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1_2(W(1,1),W(1,2),GC_11,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,3),W(1,4),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,2),W(1,4),W(1,5),GC_10,AMP(2))
